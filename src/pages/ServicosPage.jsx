...
const services = [
  ...
  },
  {
    ...
    features: [
      "Descarrego eficiente",
      "Redução de transporte direto",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            A Locar oferece um serviço completo e moderno de gestão de resíduos
            gerados por municípios, indústrias e comércio, que conta com
            gerenciamento técnico, administrativo, operacional, fiscalização e
            apoio logístico.
          </p>
          <p className="text-lg text-gray-500 mt-4">
            Com experiência e conhecimento, nosso departamento técnico cuida dos
            projetos e da implantação dos procedimentos operacionais, garantindo
            uma prestação de serviço baseada no planejamento e no controle de
            qualidade.
          </p>
        </div>
              ...
              {activeService.image && (
                <img
                  ...
                  style={{
                    ...
                    objectPosition: activeService.objectPosition ?? "center",
                  }}
                />
              )}
              <div className="p-8">
